...
def causal_conv1d_fn(x, weight, bias=None, activation=None):
    # Detectar y arreglar dimensiones de los pesos si es necesario
    # El código original a veces pasa (D, K), pero conv1d necesita (D, 1, K)
    if weight.dim() == 2:
    ...
    out = F.conv1d(x, weight, bias, padding=padding, groups=x.shape[1])
...
#new modification made for MacOS
try:
